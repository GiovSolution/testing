			...
			if ($report_groupby == '')
				...
				$sql_dokter =  "select dokter_id, karyawan_nama
								...
								where 
									...
									m1.jrawat_stat_dok = 'Tertutup'
									and (r1.rawat_kategori = 3)
									and t1.dtrawat_petugas1 <> 0 and k1.karyawan_nama not like '%available%' /*available dr*/
								...
								where 
									...
									and (r2.rawat_kategori = 3)
									and k2.karyawan_nama not like '%available%' /*available dr*/
								...
								where 
									...
									and t3.dtrawat_petugas1 <> 0 and k3.karyawan_nama not like '%available%' /*available dr*/
								...
								where 
									...
									and k4.karyawan_nama not like '%available%' /*available dr*/
								)
								as t
