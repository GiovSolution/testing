<? /* 
	GIOV Solution - Keep IT Solution
*/
...
class M_appointment extends Model{
	...
	function detail_appointment_detail_medis_list($master_id,$query,$start,$end) {
		...
		$query="SELECT * FROM appointment_detail INNER JOIN perawatan ON dapp_perawatan=rawat_id INNER JOIN kategori ON rawat_jenis=kategori_id WHERE (kategori_id='2' or kategori_id='4' or kategori_id='16') AND dapp_master='$master_id'";
	...
	function detail_appointment_detail_nonmedis_list($master_id,$query,$start,$end) {
		//$query = "SELECT * FROM appointment_detail WHERE dapp_master='".$master_id."'";
		$query="SELECT * FROM appointment_detail INNER JOIN perawatan ON dapp_perawatan=rawat_id INNER JOIN kategori ON rawat_jenis=kategori_id WHERE kategori_id='3' AND dapp_master='$master_id'";
		$result = $this->db->query($query);
		$nbrows = $result->num_rows();
		$limit = $query." LIMIT ".$start.",".$end;			
		$result = $this->db->query($limit);  
