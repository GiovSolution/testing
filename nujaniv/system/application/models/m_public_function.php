...
/*		if($rawat_kategori==2)
	...
	function get_jenis_perawatan_list($query){
		$sql="SELECT jenis_id,jenis_nama FROM jenis WHERE jenis_kelompok='perawatan' AND jenis_aktif='Aktif'";
		if($query<>""){
			$sql=$sql." and jenis_nama like '%".$query."%' or jenis_kode like '%".$query."%'  ";
		}
	...
	function get_customer_list($query,$start,$end){
		...
		if($query<>""){
			$sql=$sql." and (cust_panggilan like '%".$query."%' or cust_no like '%".$query."%' or cust_alamat like '%".$query."%' or cust_nama like '%".$query."%' or cust_telprumah like '%".$query."%' or cust_telprumah2 like '%".$query."%' or cust_telpkantor like '%".$query."%' or cust_hp like '%".$query."%' or cust_hp2 like '%".$query."%' or cust_hp3 like '%".$query."%' or date_format(cust_tgllahir,'%d-%m') like '%".$query."%' ) ";
		}
	...
	function pengecekan_dokumen($tanggal_pengecekan){
		...
		$date = date('Y-m-d');
			...
			$nextmonth=strtotime("+11month",$begin);
