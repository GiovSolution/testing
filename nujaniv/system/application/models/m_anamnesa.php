...
class M_anamnesa extends Model{
		...
		function anamnesa_update($anam_id ,$anam_cust ,$anam_tanggal ,$anam_petugas ,$anam_pengobatan ,$anam_perawatan ,$anam_terapi ,$anam_alergi ,
								 $anam_obatalergi ,$anam_efekobatalergi ,$anam_hamil ,$anam_kb ,$anam_harapan, $anam_image_sebelum, $anam_image_sesudah ){
			$data = array(
				"anam_id"=>$anam_id, 
				...
				"anam_image_sebelum"=>$anam_image_sebelum, 
				"anam_image_sesudah"=>$anam_image_sesudah 
			);
