	...
	function get_satuan_by_produk_racik_list($djproduk_id,$produk_id){
		...
		$temp_aktif=$th.$ki.$hr.$tp.$dps.$jkt.$mta.$blpn.$kuta.$corp.$mks.$mdn.$lbk.$mnd.$ygk.$mlg.$btm.'000'.$smg;
			...
			if(is_numeric($produk_group) || is_numeric($produk_jenis)){
				...
				$sql_j="SELECT jenis_id,jenis_kode FROM jenis WHERE jenis_id='".$produk_kategori."'";
			...
			$sql="SELECT jenis_id FROM jenis WHERE jenis_id='".$produk_kategori."'";
			...
			if($rs->num_rows())
			{
				$data["produk_kategori"]=$produk_kategori;
							...
							$sql_g="SELECT jenis_id, jenis_kode FROM jenis WHERE jenis_id='".$produk_kategori."'";
							$rs_g=$this->db->query($sql_g);
							if($rs_g->num_rows()){
								$rs_sql_g=$rs_g->row();
								$kategori_kode=$rs_sql_g->jenis_kode;
								$data["produk_kategori"]=$produk_kategori;
							}	
							//get group2 kode
