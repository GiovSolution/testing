...
class C_perawatan extends Controller {
	...
	function get_jenis_perawatan_list(){
		...
		$result=$this->m_public_function->get_jenis_perawatan_list($query);
		echo $result;
	}
	...
	function perawatan_update(){
		...
		$rawat_harga_hpp=trim(@$_POST["rawat_harga_hpp"]);
