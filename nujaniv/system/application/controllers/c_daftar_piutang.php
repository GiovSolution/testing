...
//class of bank
class c_daftar_piutang extends Controller {

	//constructor
	function c_daftar_piutang(){
		parent::Controller();
		session_start();
		$this->load->model('m_daftar_piutang', '', TRUE);
	...
	function index(){
		...
		$this->load->view('main/v_daftar_piutang');
	}
	...
	function get_akun_list(){
		$result=$this->m_daftar_piutang->get_akun_list();
		echo $result;
	}
	...
	function detail_list_piutang_list(){
		$query = isset($_POST['query']) ? $_POST['query'] : "";
		$start = (integer) (isset($_POST['start']) ? $_POST['start'] : $_GET['start']);
		$end = (integer) (isset($_POST['limit']) ? $_POST['limit'] : $_GET['limit']);
		$master_id = (integer) (isset($_POST['master_id']) ? $_POST['master_id'] : $_GET['master_id']);
		$cust_id = (integer) (isset($_POST['cust_id']) ? $_POST['cust_id'] : $_GET['cust_id']);
		$result=$this->m_daftar_piutang->detail_list_piutang_list($master_id, $cust_id ,$query,$start,$end);
		echo $result;
	}

	//function fot list record
	function daftar_piutang_list(){
		
		$query = isset($_POST['query']) ? $_POST['query'] : "";
		$start = (integer) (isset($_POST['start']) ? $_POST['start'] : $_GET['start']);
		$end = (integer) (isset($_POST['limit']) ? $_POST['limit'] : $_GET['limit']);

		$result=$this->m_daftar_piutang->daftar_piutang_list($query,$start,$end);
		echo $result;
	}
	...
	function ship_update(){
		...
		*/
		...
		$result = $this->m_daftar_piutang->ship_update($ship_id , $ship_nama , $ship_keterangan ,$ship_aktif );
		echo $result;
	}
	...
	function bank_create(){
		...
		*/
		...
		$result=$this->m_daftar_piutang->ship_create($ship_nama, $ship_keterangan ,$ship_aktif ,$ship_creator ,$ship_date_create ,$ship_update ,$ship_date_update ,$ship_revised );
		echo $result;
	}
	...
	function bank_delete(){
		...
		$result=$this->m_daftar_piutang->bank_delete($pkid);
		echo $result;
	}
	...
	function bank_search(){
		...
		$start = (integer) (isset($_POST['start']) ? $_POST['start'] : $_GET['start']);
		$end = (integer) (isset($_POST['limit']) ? $_POST['limit'] : $_GET['limit']);
		$result = $this->m_daftar_piutang->bank_search($bank_id ,$bank_kode ,$bank_nama ,$bank_norek ,$bank_atasnama ,$bank_saldo ,$bank_keterangan ,$bank_aktif ,$bank_creator ,$bank_date_create ,$bank_update ,$bank_date_update ,$bank_revised ,$start,$end);
		echo $result;
	}
	...
	function bank_print(){
		...
		$result = $this->m_daftar_piutang->bank_print($bank_id ,$bank_kode ,$bank_nama ,$bank_norek ,$bank_atasnama ,$bank_saldo ,$bank_keterangan ,$bank_aktif ,$bank_creator ,$bank_date_create ,$bank_update ,$bank_date_update ,$bank_revised ,$option,$filter);
	...
	function bank_export_excel(){
		...
		$query = $this->m_daftar_piutang->bank_export_excel($bank_id ,$bank_kode ,$bank_nama ,$bank_norek ,$bank_atasnama ,$bank_saldo ,$bank_keterangan ,$bank_aktif ,$bank_creator ,$bank_date_create ,$bank_update ,$bank_date_update ,$bank_revised ,$option,$filter);
