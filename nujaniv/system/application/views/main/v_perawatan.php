...
Ext.onReady(function(){
	...
	function perawatan_create(){
		...
		var rawat_harga_hpp_create=null; 
		...
		if(rawat_hargahppField.getValue()!== null){rawat_harga_hpp_create = convertToNumber(rawat_hargahppField.getValue());}
		...
		Ext.Ajax.request({  
			...
			params: {
				...
				rawat_harga_hpp	: rawat_harga_hpp_create, 
	...
	function perawatan_reset_form(){
		...
		rawat_hargahppField.reset();
		rawat_hargahppField.setValue(null);
		...
		rawat_hargahppField.setValue(0);
	...
	function perawatan_set_form(){
		...
		rawat_kategoriField.setValue(perawatanListEditorGrid.getSelectionModel().getSelected().get('rawat_jenis'));
		...
		rawat_hargahppField.setValue(CurrencyFormatted(perawatanListEditorGrid.getSelectionModel().getSelected().get('rawat_harga_hpp')));
	...
	perawatan_DataStore = new Ext.data.Store({
		...
		reader: new Ext.data.JsonReader({
			...
			{name: 'rawat_harga_hpp', type: 'float', mapping: 'rawat_harga_hpp'}, 
	...
	cbo_rawat_groupDataStore = new Ext.data.Store({
		...
		/* dataIndex => insert intocustomer_note_ColumnModel, Mapping => for initiate table column */ 
			...
			{name: 'rawat_group_kelompok', type: 'string', mapping: 'jenis_nama'},
			{name: 'rawat_group_kelompok_id', type: 'int', mapping: 'jenis_id'}
		]),
	...
	var rawat_jenis_tpl = new Ext.XTemplate(
        '<tpl for="."><div class="search-item">',
            '<span><b>{rawat_kategori_display}</b><br /></span>',
        '</div></tpl>'
    );
	...
	cbo_rawat_kategoriDataStore = new Ext.data.Store({
		...
		/* dataIndex => insert intocustomer_note_ColumnModel, Mapping => for initiate table column */ 
			{name: 'rawat_kategori_value', type: 'int', mapping: 'jenis_id'},
			{name: 'rawat_kategori_display', type: 'string', mapping: 'jenis_nama'}
		]),
		sortInfo:{field: 'rawat_kategori_display', direction: "ASC"}
	});
	...
	/* Identify  rawat_harga_hpp Field */
	rawat_hargahppField= new Ext.form.TextField({
		id: 'rawat_hargahppField',
		name: 'rawat_hargahppField',
		fieldLabel: 'Harga HPP (Rp)',
		valueRenderer: 'numberToCurrency',
		itemCls: 'rmoney',
		allowBlank: true,
		width: 120,
...
*/
		...
		items:[
			{
				...
				layout: 'form',
				border:false,
				items: [/*rawat_kodelamaField,*/ rawat_kodeField, rawat_namaField, /*rawat_highmarginField,*/ /*rawat_edit_hargaField,*/ /*rawat_groupField,*/ rawat_jenisField,rawat_kategoriField,  rawat_hargaField, rawat_hargahppField, rawat_diskonGroup/* rawat_harga_checkField,*/ /*rawat_kategoritxtField*/ /*, rawat_hargaGroup*/] 
			}
			,{
				columnWidth:0.5,
				layout: 'form',
	...
	cbo_rawat_produkDataStore = new Ext.data.Store({
		...
		proxy: new Ext.data.HttpProxy({
			...
			{name: 'rawat_produk_kategori', type: 'string', mapping: 'jenis_nama'},
