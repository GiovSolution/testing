		...
		items:[
			{
				...
				layout: 'form',
				border:false,
				items: [produk_kodelamaField, produk_kodeField, produk_groupField, produk_jenisField, produk_kategoritxtField, produk_namaField, produk_racikanField, produk_edit_hargaField, produk_hargaField, produk_harga_checkField, produk_hargaGroup] 
			}
			,{
				columnWidth:0.5,
				layout: 'form',
				border:false,
				items: [produk_awal_jumlahField, produk_awal_nilaiField, produk_tanggal_awal_nilaiField, produk_pointField, produk_kreditField,produk_volumeField, produk_kontribusiField, produk_keteranganField, produk_bpomField,produk_idField, produk_aktifGroup, produk_diskonGroup] 
			}
			]
