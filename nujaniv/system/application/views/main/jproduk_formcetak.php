...
<?php
function myheader($jproduk_tanggal ,$cust_no ,$cust_nama ,$cust_alamat ,$jproduk_nobukti, $jproduk_jam, $jproduk_karyawan, $jproduk_karyawan_no, $jproduk_creator){
?>
...
?>
		...
		foreach($detail_jproduk as $list => $row){
			$i+=1;
			if(($i%15)==1){
				myheader($f_jproduk_tanggal ,$f_cust_no ,$f_cust_nama ,$f_cust_alamat ,$f_jproduk_nobukti, $f_jproduk_jam, $f_jproduk_karyawan, $f_jproduk_karyawan_no, $f_jproduk_creator);
				content_header();
			}
	  ?>
  	  <tr>
  	  ...
  	  <?php 
			...
			if($i==$dcount){
				...
				myfooter($subtotal ,$total ,$f_cara_bayar1 ,$f_nilai_bayar1 ,$f_cara_bayar2 ,$f_nilai_bayar2 ,$f_cara_bayar3 ,$f_nilai_bayar3
						 ,$total_voucher ,$total_diskon_tamb, $f_iklantoday_keterangan, $f_jproduk_creator);
			}elseif(($i>1) && ($i%15==0)){
				content_footer();
...
<table width="1240px" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="280px"><?=$f_jproduk_creator;?></td>
    <td width="320px">&nbsp;</td>
    <td width="180px">&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td align="right">Voucher : <?php if($total_voucher<>0){?>
