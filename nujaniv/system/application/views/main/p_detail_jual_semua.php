				...
				foreach($data_print as $print_list) { ?><?php 
					if($print_list->no_bukti==$print->no_bukti){ 
						...
						if ($print->status !== 'Batal'){ 
							...
							if ($jenis <> 'Paket') {
							$total_laba+=($print_list->subtotal)-($print_list->harga_hpp*$print_list->jumlah_barang);
							$sub_laba+=($print_list->subtotal)-($print_list->harga_hpp*$print_list->jumlah_barang);
							$laba=($print_list->subtotal)-($print_list->harga_hpp*$print_list->jumlah_barang);
							}
						}
				?>
						<tr>
							...
							*/
							...
							<? if ($jenis <> 'Paket') { ?> 
								<td class="numeric"><?php echo number_format($laba,0,",",","); ?></td>
							<? } ?> 
						</tr><?php } ?><?php } ?>
						<tr> 
							<?//<td></td>?>
							...
							<? if ($jenis <> 'Paket') { ?> 
								<td align="right" class="numeric"><b><?php echo number_format($sub_laba,0,",",","); ?></b></td>
							<? } ?> 
						</tr>
						<tr> 
							<?//<td></td>?>
							<td colspan="4"><b>
								<table class="bayar">
									<tr>
										...
										<td align="right" class="title" width="50" height="17"><b>Debet</b></td> 
									</tr>
								</table>
							</td>  
							<? if ($jenis == 'Perawatan' || $jenis == 'Paket'){ ?>
...
<tr> 
	...
	<td class="foot">&nbsp;</td> 
	<th scope='row' colspan="7">Cara Bayar :</th>
</tr> 
<tr> 
	<?//<td></td>?>
	<td class="foot">&nbsp;</td> 
	...
	<td class="numeric foot" nowrap="nowrap" colspan="2">&nbsp;&nbsp;<b>Est. After Charge : </b><?php echo number_format($total_card-($total_card*2.25/100),0,",",","); ?></td>
...
<tr> 
	...
	<? } else {?>
		<td class="foot">&nbsp;</td> 
		<th scope='row' nowrap="nowrap">-</th> 
		<td class="numeric foot" nowrap="nowrap" >-</td> 
	<? } ?>
		<td class="foot">&nbsp;</td> 
		<th scope='row' nowrap="nowrap">Debet (Rp)</th> 
...
<? if ($jenis <> 'Paket') { ?>
	...
	<?//<td></td>?>
	<td class="foot">&nbsp;</td> 
	<th scope='row' nowrap="nowrap">Total Laba (Rp)</th> 
	<td class="numeric foot" nowrap="nowrap" ><?php echo number_format($total_laba-$total_voucher,0,",",","); ?></td> 
	<td colspan="9" class="foot">&nbsp;</td> 
	</tr> 
	<tr> 
	<?//<td></td>?>
	<td class="foot">&nbsp;</td> 
	<th scope='row' nowrap="nowrap">Total Bank Charge (Rp)</th> 
	<td class="numeric foot" nowrap="nowrap" >(<?php echo number_format($total_card-($total_card-($total_card*2.25/100)),0,",",","); ?>)</td> 
	<td colspan="8" class="foot">&nbsp;</td> 
</tr> 
<tr> 
	<?//<td></td>?>
	<td class="foot">&nbsp;</td> 
	<th scope='row' nowrap="nowrap">Total Net Laba (Rp)</th> 
	<td class="numeric foot" nowrap="nowrap" ><?php echo number_format(($total_laba-$total_voucher)-($total_card-($total_card-($total_card*2.25/100))),0,",",","); ?></td> 
	<td colspan="8" class="foot">&nbsp;</td> 
</tr> 
<? } ?>
