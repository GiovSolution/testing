...
*/
	...
	function master_jual_rawat_reset_form(){	
		...
		jrawat_cashback_cf_persenField.reset(); 
		jrawat_cashback_cf_persenField.setValue(null);
		jrawat_cashback_cf_medis_persenField.reset(); 
		jrawat_cashback_cf_medis_persenField.setValue(null);
		...
		jrawat_cashback_cf_persenField.setDisabled(false);
		jrawat_cashback_cf_medis_persenField.setDisabled(false);
	...
	function master_jual_rawat_set_updating(){
            ...
            if(jrawat_post2db=="UPDATE" && (master_jual_rawatListEditorGrid.getSelectionModel().getSelected().get('jrawat_stat_dok')=="Tertutup" || master_jual_rawatListEditorGrid.getSelectionModel().getSelected().get('jrawat_stat_dok')=="Batal")){
                ...
                jrawat_cashback_cf_persenField.setDisabled(true);
                jrawat_cashback_cf_medis_persenField.setDisabled(true);
	...
	jrawat_cashback_cf_persenField= new Ext.form.TextField({
		id: 'jrawat_cashback_cf_persenField',
		fieldLabel: 'Voucher (%)',
		allowNegatife : false,
		readOnly : false,
		enableKeyEvents: true,
		...
		listeners: {
			'keyup': function(){
				jrawat_cashback_cfField.setValue(convertToNumber(jrawat_subTotal_cfField.getValue())*convertToNumber(jrawat_cashback_cf_persenField.getValue())/100);
				
				var cf_tonumber = convertToNumber(jrawat_cashback_cfField.getValue());
				jrawat_cashback_num.setValue(cf_tonumber);
				load_total_biaya();
				load_total_bayar();
				//var number_tocf = CurrencyFormatted(this.getValue());
	...
	jrawat_cashback_cf_medis_persenField= new Ext.form.TextField({
		id: 'jrawat_cashback_cf_medis_persenField',
		fieldLabel: 'Voucher (%)',
		allowNegatife : false,
		readOnly : false,
		enableKeyEvents: true,
		...
		listeners: {
			'keyup': function(){
				jrawat_cashback_cf_medisField.setValue(convertToNumber(jrawat_subTotal_cfField.getValue())*convertToNumber(jrawat_cashback_cf_medis_persenField.getValue())/100);
				
				var cf_tonumber = convertToNumber(jrawat_cashback_cf_medisField.getValue());
				jrawat_cashback_medis_num.setValue(cf_tonumber);
				load_total_biaya();
				load_total_bayar();
			}
		...
		items:[
			{
				layout: 'form',
				border:false,
				items: [/*jrawat_no_faktur_pajakField, */ {xtype: 'spacer',height:28}, /*jrawat_jumlah_nonmedisField, */ /*jrawat_dpp_Field, */ /*jrawat_diskon_nonmedisField, */ jrawat_ket_diskField, jrawat_cashback_cfField, jrawat_cashback_cf_persenField   /*, jrawat_voucher_dppField, jrawat_subTotal_nonmedisField,jrawat_ppn_Field, jrawat_um_nonmedisField*/,{xtype: 'spacer',height:28}/*, jrawat_total_nonmedisField */]
			}
			]
	});
		...
		items:[
			{
				layout: 'form',
				border:false,
				items: [/*jrawat_no_faktur_medisField,  */ {xtype: 'spacer',height:28}, /*jrawat_jumlah_medisField, jrawat_subTotal_medisField, jrawat_diskon_medisField, */ jrawat_ket_disk_medisField, jrawat_cashback_cf_medisField, jrawat_cashback_cf_medis_persenField /*, {xtype: 'spacer',height:80}, jrawat_um_medisField*/,{xtype: 'spacer',height:28}/*, jrawat_total_medisField */] 
			}
			]
	});
	...
	jrawat_caraField= new Ext.form.ComboBox({
		...
		store:new Ext.data.SimpleStore({
			...
			data:[['tunai','Tunai'],['kwitansi','Kuitansi'],['card','Kartu Kredit'],['cek/giro','Debet'],['transfer','Transfer']]
		}),
		mode: 'local',
	...
	//ini diganti menjadi Debet, tetapi tabel nya tetep mengarah ke jual_cek
...
*/
	...
	jrawat_caraSearchField= new Ext.form.ComboBox({
		...
		store:new Ext.data.SimpleStore({
			...
			data:[['tunai','Tunai'],['kwitansi','Kwitansi'],['card','Kartu Kredit'],['cek/giro','Debet'],['transfer','Transfer'],['voucher','Voucher']]
		}),
		mode: 'local',
