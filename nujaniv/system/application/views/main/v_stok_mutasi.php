...
Ext.onReady(function(){
	...
	stok_mutasi_group1_DataStore = new Ext.data.Store({
		...
		reader: new Ext.data.JsonReader({
			...
			{name: 'group_id', type: 'int', mapping: 'jenis_id'}, 
			{name: 'group_kode', type: 'string', mapping: 'jenis_kode'}, 
			{name: 'group_nama', type: 'string', mapping: 'jenis_nama'}
		]),
	...
	stok_mutasi_ColumnModel = new Ext.grid.ColumnModel(
		...
		},
		{
			...
			renderer: function(value, cell, record){
				...
				if(record.data.jumlah_stok<=6 && record.data.jumlah_stok>=2){
					return '<span style="color:#713b8d; font-size:120%;"><b>' + Ext.util.Format.number(value,'0,000') + '</span>';
				}else if(record.data.jumlah_stok<=2){
					return '<span style="color:red; font-size:150%;"><b>' + Ext.util.Format.number(value,'0,000') + '</span>';
				}else{
