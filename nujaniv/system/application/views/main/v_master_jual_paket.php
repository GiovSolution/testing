...
Ext.override(Ext.form.Field, {
	...
	function master_jual_paket_reset_form(){
		...
		jpaket_cashback_cf_persenField.reset();
		jpaket_cashback_cf_persenField.setValue(null);
		...
		jpaket_cashback_cf_persenField.setDisabled(false);
	...
	function master_jual_paket_set_updating(){
		...
		if(jpaket_post2db=="UPDATE" && master_jual_paketListEditorGrid.getSelectionModel().getSelected().get('jpaket_stat_dok')=="Tertutup"){
			...
			jpaket_cashback_cf_persenField.setDisabled(true);
	...
	*/
	...
	jpaket_cashback_cf_persenField= new Ext.form.TextField({
		id: 'jpaket_cashback_cf_persenField',
		//fieldLabel: '(Rp)', --> Nanti di comment semua aja fieldLabelnya.. 
		fieldLabel : 'Voucher (%)',
		allowNegatife : false,
		readOnly : false,
		...
		listeners: {
			'keyup': function(){
				jpaket_cashback_cfField.setValue(convertToNumber(jpaket_subTotal_cfField.getValue())*convertToNumber(jpaket_cashback_cf_persenField.getValue())/100);
				
				var cf_tonumber = convertToNumber(jpaket_cashback_cfField.getValue());
				jpaket_cashback_num.setValue(cf_tonumber);
				load_total_biaya();
				/*
...
/*jpaket_ket_diskField= new Ext.form.TextField({
	...
	//Ini diganti menjadi Tunai Debet .. Tabelnya tapi tetep tabel jual_cek
	...
	master_jual_paket_bayarGroup = new Ext.form.FieldSet({
		...
		items:[
			...
			,{
				...
				border:false,
				labelAlign: 'left',
				items: [/*jpaket_jumlahField,*/jpaket_jumlahLabel, jpaket_subTotalLabel, jpaket_cashback_cfField, jpaket_cashback_cf_persenField, jpaket_ket_diskField, /*master_jual_paket_voucher_group,*/ {xtype: 'spacer',height:10},jpaket_TotalLabel, jpaket_TotalBayarLabel,jpaket_HutangLabel ,jpaket_pesanLabel ,jpaket_lunasLabel] 
			}
			]
	});
	/*Fieldset Master*/
