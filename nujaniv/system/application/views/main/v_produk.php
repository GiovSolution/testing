...
Ext.onReady(function(){
	...
	function produk_create(){
		...
		var produk_harga_beli_create=null; 
		...
		if(produk_hargabeliField.getValue()!== null){produk_harga_beli_create = convertToNumber(produk_hargabeliField.getValue());} 
		/*
		...
		*/
		...
		Ext.Ajax.request({  
			...
			params: {
				...
				produk_harga_beli		: produk_harga_beli_create, 
	...
	function produk_reset_form(){
		...
		produk_hargabeliField.reset();
		produk_hargabeliField.setValue(null);
		...
		produk_hargabeliField.setValue(0);
	...
	function produk_set_form(){
		...
		produk_hargabeliField.setValue(CurrencyFormatted(produkListEditorGrid.getSelectionModel().getSelected().get('produk_harga_beli')));
	...
	produk_DataStore = new Ext.data.Store({
		...
		/* dataIndex => insert intoproduk_ColumnModel, Mapping => for initiate table column */ 
			...
			{name: 'produk_harga_beli', type: 'float', mapping: 'produk_harga_beli'}, 
	...
	cbo_produk_kategori_jenisDataStore = new Ext.data.Store({
		...
		/* dataIndex => insert intocustomer_note_ColumnModel, Mapping => for initiate table column */ 
			{name: 'produk_kategori_jenis_value', type: 'int', mapping: 'jenis_id'},
			{name: 'produk_kategori_jenis_display', type: 'string', mapping: 'jenis_nama'},
...
//	});
	...
	/* Identify  produk_harga_beli Field */
	produk_hargabeliField= new Ext.form.TextField({
		id: 'produk_hargabeliField',
		name: 'produk_hargabeliField',
		...
		items:[
			{
				...
				layout: 'form',
				border:false,
				items: [/*produk_kodelamaField, */ produk_kodeField,/* produk_groupField,*/ produk_jenisField, /*produk_kategoritxtField, */ produk_namaField, /*produk_racikanField, produk_edit_hargaField, */ produk_hargaField, produk_hargabeliField, produk_diskonGroup/* produk_harga_checkField, produk_hargaGroup */] 
			}
			,{
				columnWidth:0.5,
				layout: 'form',
...
//	});
	...
	produk_hargabeliField.on('focus',function(){ produk_hargabeliField.setValue(convertToNumber(produk_hargabeliField.getValue())); });
	produk_hargabeliField.on('blur',function(){ produk_hargabeliField.setValue(CurrencyFormatted(produk_hargabeliField.getValue())); });
