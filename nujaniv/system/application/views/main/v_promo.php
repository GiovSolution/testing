...
Ext.onReady(function(){
		...
		Ext.Ajax.request({  
			...
			success: function(response){             
				...
				if(result!==0){
						...
						Ext.MessageBox.alert(post2db+' OK','Data Customer Ultah berhasil disimpan');
						...
						Ext.MessageBox.show({
						   ...
						   msg: 'Data Customer Ultah tidak bisa disimpan',
	...
	promo_DataStore = new Ext.data.Store({
		...
		reader: new Ext.data.JsonReader({
			...
			{name: 'promo_id', type: 'int', mapping: 'cust_id'}, 
			{name: 'promo_acara', type: 'string', mapping: 'cust_nama'}, 
			{name: 'promo_tempat', type: 'string', mapping: 'cust_alamat'}, 
			{name: 'promo_keterangan', type: 'string', mapping: 'cust_telp'}, 
			{name: 'promo_tglmulai', type: 'date', dateFormat: 'Y-m-d', mapping: 'cust_tgllahir'}, 
			{name: 'promo_tglselesai', type: 'date', dateFormat: 'Y-m-d', mapping: 'cust_tgllahir'}, 
			{name: 'promo_diskon', type: 'float', mapping: 'umur'}, 
	...
	promo_ColumnModel = new Ext.grid.ColumnModel(
		...
		/*
		{
			header: '<div align="center">' + 'Tgl Transaksi Awal' + '</div>',
	...
	promo_searchWindow = new Ext.Window({
		title: 'Pencarian Customer Ultah',
		closable:true,
		closeAction: 'hide',
		autoWidth: true,
		autoHeight: true,
