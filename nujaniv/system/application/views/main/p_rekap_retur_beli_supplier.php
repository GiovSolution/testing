...
<table summary='Laporan Rekap Penerimaan Barang'>
	<caption>Laporan Rekap Retur Barang<br/><?php echo $periode; ?><br/>Group By Supplier</caption>
	<thead>
    	<tr>
        	<th scope='col'>No</th>
	...
	<tbody>
		<?php	$i=0; $supplier=""; $j=0; 
				...
				foreach($data_print as $print) { 
					...
					$i=0;
		?>
          <?php if($supplier!==$print->supplier_nama) { 
								
			?>
           <tr>
                <td><b><? $j++; echo $j; ?></b></td>
                <td colspan="12"><b><?php echo $print->supplier_nama; ?></b></td>
           </tr>
           <?php foreach($data_print as $print_list) {   ?>
           <?php if($print_list->supplier_nama==$print->supplier_nama){ $i++; 
