...
<table width="1240px" border="0px" cellpadding="0px" cellspacing="0px">
	...
	<tr>
	  <td height="20px"><table width="1240px" height="10px" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="200px">&nbsp;</td>
          <td width="1040px" valign="bottom">NO NOTA : <?=$jrawat_nobukti;?></td>
        </tr>
      </table></td>
  </tr>
  	<tr>
	...
	<tr>
	  ...
	  <?php }?>
        ...
        <tr>
          ...
          <td width="150px" align="center">&nbsp;<?=$row->drawat_jumlah;?></td>
          <td width="160px" align="center">&nbsp;<?=rupiah($row->drawat_harga);?></td>
          <td width="170px" align="center">&nbsp;<?=$row->drawat_diskon;?></td>
